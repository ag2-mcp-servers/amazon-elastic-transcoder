...
This project is an MCP (Model Context Protocol) Server for the given OpenAPI URL - https://api.apis.guru/v2/specs/amazonaws.com/elastictranscoder/2012-09-25/openapi.json, auto-generated using AG2's [MCP builder](https://mcp.ag2.ai).
